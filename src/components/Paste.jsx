  ...
  return (
    <div className="bg-gray-600 h-screen w-screen">
      ...
      <div className=" w-full flex gap-3 px-4 py-2 rounded-[0.3rem] mb-4 bg-white border border-[rgba(128,121,121,0.3)] mt-6">
        ...
        />
        <Search className="text=[20px] text-blue-500"/>
      </div>
      <div className=" flex flex-col border border-[rgba(128,121,121,0.3)] pb-4">
        <h2 className=" px-4 text-4xl font-bold text-blue-500 border-b pb-4 border-[rgba(128,121,121,0
        3)]">
          All Pastes
        </h2>
          ...
          filteredData.map((paste) =>  (
              ...
              <div className="border border-[rgba(128,121,121,0.3)] w-full bg-white gap-y-6 justify-between flex flex-col sm:flex-row p-4 rounded-[0.3rem]" key={paste?._id}>
                <div className=" w-[50%] flex flex-col space-y-3">
                  <p className="text-4xl text-blue-500 font-semibold">{paste?.title}</p>
                  <p className="text-mdfont-normal text-black line-clamp-3 max-w-[80%] text-[#707070]">{paste?.content}</p>
                </div>
                
                <div className="flex flex-col gap-y-4 text-blue-500 sm:items-end">
